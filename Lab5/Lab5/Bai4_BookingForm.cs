...
namespace Lab5
{
    public partial class Bai4_BookingForm : Form
    {
        ...
        private void Bai4_BookingForm_Load(object sender, EventArgs e)
        {
        ...
        private void SendConfirmationEmail(string customerName, string email, string movieTitle, string seatNumber)
        {
            ...
            mailMessage.From = new MailAddress("quoccuongluu03@gmail.com");
            ...
            smtpClient.Credentials = new NetworkCredential("quoccuongluu03@gmail.com", "xzfw uwfv ghkc gged");
